...
class PublicUsersApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test that user password is too must have more than 5 characters"""
        payload = {
            'email': 'test@test.com',
            'password': 'pw',
            'name': 'Test'
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not craeted if invalid credentials are given"""
    ...
    def test_create_token_no_user(self):
        """Test that token is not craeted if user doesn't exists"""
